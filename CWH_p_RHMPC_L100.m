...
% save simulation data
DATA4_w_Param = DATA; stop4_w_P = stop; J4_w_P = J_val; tVec4_P = tVec; nVar4 = nVar;
save('Results/res_w_P_L100','DATA4_w_Param','stop4_w_P','tVec4_P','J4_w_P','nVar4');
